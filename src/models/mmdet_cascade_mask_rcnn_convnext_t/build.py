...
from src.models.mmdet_cascade_mask_rcnn_convnext_t.config import build_mmdet_config_dict
...
DEFAULT_EXPERIMENT_CONFIG = (
    CONFIGS_EXPERIMENTS_DIR
    / "exp032_mmdet_cascade_maskrcnn_convnext_t_tile_pipeline.yaml"
)
