...
from src.models.mmdet_mask_rcnn_r101_coco.config import build_mmdet_config_dict

DEFAULT_EXPERIMENT_CONFIG = CONFIGS_EXPERIMENTS_DIR / "exp012_mmdet_maskrcnn_r101_coco.yaml"
