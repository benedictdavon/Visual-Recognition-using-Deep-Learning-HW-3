...
from src.models.mmdet_mask_rcnn_convnext_t.config import build_mmdet_config_dict

DEFAULT_EXPERIMENT_CONFIG = CONFIGS_EXPERIMENTS_DIR / "exp010_mmdet_maskrcnn_convnext_t.yaml"
